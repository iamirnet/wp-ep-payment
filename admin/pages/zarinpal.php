<?php
function i_amir_net_ep_payment_zarinpal()
{
    ...
    if ($_POST){
        ...
        $payment = i_amir_net_ep_payment_payment_select("ZarinPal");
    ...
    <div class="wrap">
        ...
        <form method="post" action="<?php echo esc_html(admin_url('admin.php?page=i_amir_net_ep_zarinpal')); ?>">
