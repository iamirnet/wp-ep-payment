<?php
function i_amir_net_ep_payment_saman()
{
    ...
    if ($_POST){
        ...
        $payment = i_amir_net_ep_payment_payment_select("Saman");
    ...
    <div class="wrap">
        ...
        <form method="post" action="<?php echo esc_html(admin_url('admin.php?page=i_amir_net_ep_saman')); ?>">
